...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtNitVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 375, 116, 30));
        ...
        TableCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NIT/CC", "NOMBRE", "TELÉFONO", "DIRECCIÓN"
            }
        ));
        ...
        jPanel9.add(txtCedulaCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 160, 30));
        ...
        jLabel17.setText("Nit/CC:");
        jPanel10.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));

        txtNitProveedor.setBorder(null);
        jPanel10.add(txtNitProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 138, 30));
        ...
        jPanel7.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, -1, -1));
        ...
        btnActualizarConfig.setBackground(new java.awt.Color(0, 51, 102));
    ...
    private void txtNitVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNitVentaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"".equals(txtNitVenta.getText())) {
                int cedula = Integer.parseInt(txtNitVenta.getText());
    ...
    private static class txtNitConfig {
        public txtNitConfig() {
        }
    }
}
